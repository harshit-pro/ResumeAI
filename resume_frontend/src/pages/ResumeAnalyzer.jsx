...
//       <h2 className="text-xl font-bold mb-4">📄 Smart ATS Resume Analyzer</h2>
...
//               : "None"}
//           </p>
//           <p><strong>Profile Summary:</strong> {analysis.profileSummary}</p>
//         </div>
//       )}
//     </div>
//   );
      ...
      <div className="max-w-4xl w-full bg-white/90 backdrop-blur-lg shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8 relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                  ...
                  >
                    ...
                    {resume ? "Change PDF" : "Upload PDF Resume"}
                  </label>
                </div>
            ...
            <button
              type="submit"
              className={`w-full p-4 rounded-xl text-white font-bold tracking-wide shadow-lg transition-all ${
          ...
          {analysis && (
            <div className="mt-8 space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <div className="prose max-w-none"> {/* Classes moved here */}
          <ReactMarkdown 
